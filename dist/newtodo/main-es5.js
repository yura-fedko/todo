...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.regUser = function (body) {
...
var TaskComponent = /** @class */ (function () {
    function TaskComponent(router) {
        ...
        this.socket.on('initialTask', function (res) {
            console.log(res);
            _this.tasks = res.filter(filterByOwner);
    ...
    TaskComponent.prototype.editTaskFn = function (task, title) {
        if (title !== '') {
            this.socket.emit('editTask', { id: task._id, title: title });
        }
    };
    TaskComponent.prototype.addCoOwner = function (task, email) {
        if (email !== '') {
            this.socket.emit('addCoOwner', { id: task._id, email: email });
        }
    };
    TaskComponent.prototype.editBtn = function (task) {
...
var TaskGuard = /** @class */ (function () {
    function TaskGuard(router) {
        this.router = router;
        this.state = _data__WEBPACK_IMPORTED_MODULE_2__["State"];
    }
    TaskGuard.prototype.canActivate = function (route, state) {
    ...
    TaskGuard.ctorParameters = function () { return [
